...
import employLogo from '../../assets/images/employlogo.png';
...
export default function SignUpScreen() {
  ...
  const renderCredentialsStep = () => (
    <>
      ...
      <Text style={styles.subtitle}>Sign up to start using EmployApp</Text>
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.logoContainer}>
                <Image 
                  source={employLogo} // Use the imported local image
                  style={styles.logo} 
                  resizeMode="contain"
                />
                <Text style={styles.appName}>EmployApp</Text>
              </View>
